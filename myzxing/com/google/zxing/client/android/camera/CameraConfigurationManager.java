...
//  private static final int DESIRED_SHARPNESS = 30;
  ...
  void setDesiredCameraParameters(Camera camera) {
    Camera.Parameters parameters = camera.getParameters();
    if (Integer.parseInt(Build.VERSION.SDK) >= 8) {// 鍒ゆ柇绯荤粺鐗堟湰鏄惁澶т簬绛変簬2.2
		setDisplayOrientation(camera, 90);// 鏃嬭浆90掳锛屽墠鎻愭槸褰撳墠椤祊ortrait锛岀旱鍚�	} else {// 绯荤粺鐗堟湰鍦�.2浠ヤ笅鐨勯噰鐢ㄤ笅闈㈢殑鏂瑰紡鏃嬭浆
...
//    setDisplayOrientation(camera , 90);//鏃嬭浆瑙掑害
